  ...
  useEffect(() => {
    if (addUserProductCartData.loading) {
      ...
      if (addUserProductCartData?.data?.request?.data) {
        ...
        if (isExist) {
          showToast("Bạn đã thêm sản phẩm này vào giỏ rồi", "info");
        } else {
      ...
      <div className="product__info">
        ...
        <div className="product__info-wrapper">
          ...
          <div className="product__info-param product__info-price-wrapper">
            <p className="product__info-origin">{formatMoney(product.price)}</p>
            <p className="product__info-price">
              {formatMoney(afterSale(product.price, product.sale))}
            </p>
            {product.sale > 0 && (
              <p className="product__info-sale-label">{product.sale}% giảm</p>
            )}
          </div>
          ...
          <div className="product__info-param-second product__info-ship-wrapper">
            ...
            <div className="product__info-param-second-content product__info-quantity-wrapper">
              ...
              <p className="product__info-stock-number">1255 sản phẩm có sẵn</p>
            </div>
          </div>
          ...
          <div className="product__info-interaction">
            <div className="product__info-share">
              ...
              <img src={MessengerImg} className="product__info-share-icon" />
              <img src={FacebookImg} className="product__info-share-icon" />
              <img src={PinterestImg} className="product__info-share-icon" />
              <img src={TwitterImg} className="product__info-share-icon" />
            </div>
            <div className="product__info-love">
              ...
              />
              <p className="product__info-interaction-txt">Đã thích (167)</p>
            </div>
          </div>
        </div>
      </div>
